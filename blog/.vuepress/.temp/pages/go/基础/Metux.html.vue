...
<h3 id="抢锁流程-3-个-goroutine-抢锁" tabindex="-1"><a class="header-anchor" href="#抢锁流程-3-个-goroutine-抢锁"><span>抢锁流程**（3 个 Goroutine 抢锁）**</span></a></h3>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="释放锁" tabindex="-1"><a class="header-anchor" href="#释放锁"><span>释放锁</span></a></h3>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">    }</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">}</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="解锁流程-g1-调用-unlock-当前有-g2、g3-在等待" tabindex="-1"><a class="header-anchor" href="#解锁流程-g1-调用-unlock-当前有-g2、g3-在等待"><span><strong>解锁流程</strong>（G1 调用 Unlock()，当前有 G2、G3 在等待）</span></a></h3>
...
<ul>
<li><strong>锁已被其他 Goroutine 持有</strong>（<code v-pre>mutexLocked = 1</code>）</li>
<li><strong>已有 Goroutine 被标记为唤醒</strong>（<code v-pre>mutexWoken = 1</code>）避免重复唤醒</li>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>
<h4 id="步骤-2-g2-被唤醒后抢锁" tabindex="-1"><a class="header-anchor" href="#步骤-2-g2-被唤醒后抢锁"><span><strong>步骤 2: G2 被唤醒后抢锁</strong></span></a></h4>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">| Bit 1 (mutexWoken) = 0</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">| Bit 2-31 (等待者计数) = 1 (G3 仍在等待)</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="为什么选择-1-2-4-的布局" tabindex="-1"><a class="header-anchor" href="#为什么选择-1-2-4-的布局"><span><strong>为什么选择 1/2/4 的布局？</strong></span></a></h4>
