<template><div><p><strong>Hi~</strong> <img src='https://qpluspicture.oss-cn-beijing.aliyuncs.com/6LjjQA/Hi.gif' alt='Hi' width="24"/>, <strong>五十岚 ▪ 寄</strong><br/>干啥啥不行，吃啥啥不够的 <strong>Python</strong> 混子<img src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" width="30">;<br/>没事整整前端 <strong>Vue, React</strong> <br/>干劲满满地学 <strong>Go</strong> 中...<img src="https://media.giphy.com/media/mGcNjsfWAjY5AEZNw6/giphy.gif" width="50"><br/>热爱沟通与交流😄</p>
<!--
...
<h3 id="framework" tabindex="-1"><a class="header-anchor" href="#framework" aria-hidden="true">#</a> Framework</h3>
...
<h3 id="my-profile" tabindex="-1"><a class="header-anchor" href="#my-profile" aria-hidden="true">#</a> My profile</h3>
