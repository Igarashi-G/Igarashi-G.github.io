<template><div><p><strong>k8s</strong> 的调度、网络 与 认证授权</p>
<!-- more -->
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_2-kubernetes-调度" tabindex="-1"><a class="header-anchor" href="#_2-kubernetes-调度" aria-hidden="true">#</a> 2.Kubernetes 调度</h2>
