...
<h3 id="_2-2-服务发现" tabindex="-1"><a class="header-anchor" href="#_2-2-服务发现" aria-hidden="true">#</a> 2.2 服务发现</h3>
<p><strong>k8s</strong> 集群中，组件间可以通过 <strong>Service</strong> 名称实现通信</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment">## 演示思路：在myblog的容器中直接通过service名称访问服务，观察是否可以访问通</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="" tabindex="-1"><a class="header-anchor" href="#" aria-hidden="true">#</a> </h5>
</div></template>
