<template><div><h2 id="random-模块" tabindex="-1"><a class="header-anchor" href="#random-模块" aria-hidden="true">#</a> random 模块</h2>
<h5 id="当需要创建随机数时使用" tabindex="-1"><a class="header-anchor" href="#当需要创建随机数时使用" aria-hidden="true">#</a> 当需要创建随机数时使用</h5>
<pre><code>    .random()限定了0-1的浮点数
...
<h2 id="hashlib-模块" tabindex="-1"><a class="header-anchor" href="#hashlib-模块" aria-hidden="true">#</a> hashlib 模块</h2>
<pre><code>    如abc----&gt;md5-----&gt;&quot;adas%$aseq&amp;%*SD&quot;之类的
