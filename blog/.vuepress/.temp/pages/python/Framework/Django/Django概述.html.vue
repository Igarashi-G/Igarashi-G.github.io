<template><div><h1 id="django" tabindex="-1"><a class="header-anchor" href="#django" aria-hidden="true">#</a> Django</h1>
...
<h3 id="_1-4-mtv-模式" tabindex="-1"><a class="header-anchor" href="#_1-4-mtv-模式" aria-hidden="true">#</a> 1.4 MTV 模式</h3>
...
<img src="@source/python/Framework/Django/img/MTV.png">
...
<p><a href="/data-base/postgre-sql/postgresql%E5%9F%BA%E7%A1%80" target="_blank" rel="noopener noreferrer">PostgreSQL<ExternalLinkIcon/></a> 为例</p>
