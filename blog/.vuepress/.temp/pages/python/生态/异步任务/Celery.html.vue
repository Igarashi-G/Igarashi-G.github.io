...
<ul>
<li>
<p>异步任务：将耗时操作任务提交给 Celery 去异步执行，比如发送短信/邮件、消息推送、音视频处理等等</p>
</li>
<li>
...
<p>执行以上命令，将任务启动</p>
<p>【注意】：</p>
<p>windows 下 celery 若命令行执行报错如下：</p>
<pre><code>ERROR/MainProcess] Task handler raised error: ValueError('not enough values to unpack (expected 3, got 0)')
</code></pre>
<p>需要安装 eventlet 才行（原因不明）</p>
<pre><code>pip3 install eventlet
</code></pre>
