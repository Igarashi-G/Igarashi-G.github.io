<template><div><h1 id="grpc" tabindex="-1"><a class="header-anchor" href="#grpc" aria-hidden="true">#</a> grpc</h1>
<blockquote>
<p>目前最为主流，基于 go 语言开发的 rpc，有 python<code v-pre>异步版</code> 可以和 <code v-pre>FastAPI</code> 相结合，异步，好用！</p>
</blockquote>
<h3 id="_1-部分文档" tabindex="-1"><a class="header-anchor" href="#_1-部分文档" aria-hidden="true">#</a> 1. 部分文档</h3>
<h5 id="_1-1-论文" tabindex="-1"><a class="header-anchor" href="#_1-1-论文" aria-hidden="true">#</a> 1.1 论文</h5>
<p><a href="https://github.com/grpc/proposal" target="_blank" rel="noopener noreferrer">graphics<ExternalLinkIcon/></a></p>
<h5 id="_1-2-服务配置" tabindex="-1"><a class="header-anchor" href="#_1-2-服务配置" aria-hidden="true">#</a> 1.2 服务配置</h5>
<p><a href="https://github.com/grpc/grpc/blob/master/doc/service_config.md" target="_blank" rel="noopener noreferrer">Service Config in gRPC<ExternalLinkIcon/></a>
<a href="https://grpc.github.io/grpc/core/group__grpc__arg__keys.html" target="_blank" rel="noopener noreferrer">arg_keys<ExternalLinkIcon/></a></p>
...
<p><a href="/data-base/etcd/aioetcd3" target="_blank" rel="noopener noreferrer">aioetcd3<ExternalLinkIcon/></a> 使用老版本的非 <code v-pre>aio</code> 异步，基于线程实现的库</p>
...
<p><a href="https://doc.oschina.net/grpc?t=56831" target="_blank" rel="noopener noreferrer">官方文档中文版<ExternalLinkIcon/></a></p>
<h5 id="_1-6-proto3" tabindex="-1"><a class="header-anchor" href="#_1-6-proto3" aria-hidden="true">#</a> 1.6 proto3</h5>
<p><a href="https://developers.google.com/protocol-buffers/docs/proto3#simple" target="_blank" rel="noopener noreferrer">protocol buffers<ExternalLinkIcon/></a></p>
<table>
<thead>
<tr>
<th>proto3</th>
