...
<span class="token keyword">async</span> <span class="token keyword">def</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
    ...
    url_list <span class="token operator">=</span> <span class="token punctuation">[</span>
        <span class="token string">"http://www.igarashi.icu:8999/img/Django.png"</span><span class="token punctuation">,</span>
        <span class="token string">"http://www.igarashi.icu:8999/img/antd.png"</span><span class="token punctuation">,</span>
        <span class="token string">"http://www.igarashi.icu:8999/img/etcd.png"</span><span class="token punctuation">,</span>
    <span class="token punctuation">]</span>
...
<span class="token comment">### 输出结果</span>
<span class="token comment"># start download: http://www.igarashi.icu:8999/img/Django.png</span>
<span class="token comment"># start download: http://www.igarashi.icu:8999/img/antd.png</span>
<span class="token comment"># start download: http://www.igarashi.icu:8999/img/etcd.png</span>
