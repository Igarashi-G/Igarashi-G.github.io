...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-4-打包到镜像" tabindex="-1"><a class="header-anchor" href="#_2-4-打包到镜像" aria-hidden="true">#</a> 2.4 打包到镜像</h3>
