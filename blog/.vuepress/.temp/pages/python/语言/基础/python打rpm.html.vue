...
<!-- more -->
<h1 id="python-打包" tabindex="-1"><a class="header-anchor" href="#python-打包" aria-hidden="true">#</a> python 打包</h1>
<h2 id="_1-python-打-rpm-包" tabindex="-1"><a class="header-anchor" href="#_1-python-打-rpm-包" aria-hidden="true">#</a> 1. python 打 rpm 包</h2>
<h4 id="什么是-rpm" tabindex="-1"><a class="header-anchor" href="#什么是-rpm" aria-hidden="true">#</a> 什么是 RPM</h4>
...
<h4 id="rpm-类型" tabindex="-1"><a class="header-anchor" href="#rpm-类型" aria-hidden="true">#</a> RPM 类型</h4>
<ul>
<li>
...
<div class="language-ini ext-ini line-numbers-mode"><pre v-pre class="language-ini"><code>$HOME/rpmbuild
...
<h3 id="_1-3-spec-阶段与目录的对应关系" tabindex="-1"><a class="header-anchor" href="#_1-3-spec-阶段与目录的对应关系" aria-hidden="true">#</a> 1.3 SPEC 阶段与目录的对应关系</h3>
...
<h3 id="_1-4-工具使用" tabindex="-1"><a class="header-anchor" href="#_1-4-工具使用" aria-hidden="true">#</a> 1.4 工具使用</h3>
...
<h3 id="_1-5-生成-spec-文件" tabindex="-1"><a class="header-anchor" href="#_1-5-生成-spec-文件" aria-hidden="true">#</a> 1.5 生成 SPEC 文件</h3>
...
<h3 id="_1-6-示例文件" tabindex="-1"><a class="header-anchor" href="#_1-6-示例文件" aria-hidden="true">#</a> 1.6 示例文件：</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-7-打包命令-rpmbuild" tabindex="-1"><a class="header-anchor" href="#_1-7-打包命令-rpmbuild" aria-hidden="true">#</a> 1.7 打包命令 rpmbuild</h3>
<p>用于生成包</p>
...
<h3 id="_1-8-准备打包的源代码" tabindex="-1"><a class="header-anchor" href="#_1-8-准备打包的源代码" aria-hidden="true">#</a> 1.8 准备打包的源代码</h3>
...
<hr>
<h2 id="_2-python-项目打包-wheel" tabindex="-1"><a class="header-anchor" href="#_2-python-项目打包-wheel" aria-hidden="true">#</a> 2. python 项目打包 wheel</h2>
<p>使用 <code v-pre>python</code> 自带工具 <strong>setuptool</strong> 进行打包</p>
<h3 id="_2-1-编写-setup-py-文件" tabindex="-1"><a class="header-anchor" href="#_2-1-编写-setup-py-文件" aria-hidden="true">#</a> 2.1 编写 <a href="http://setup.py" target="_blank" rel="noopener noreferrer">setup.py<ExternalLinkIcon/></a> 文件</h3>
...
<h3 id="_2-2-编写-service-文件" tabindex="-1"><a class="header-anchor" href="#_2-2-编写-service-文件" aria-hidden="true">#</a> 2.2 编写 <code v-pre>.service</code> 文件</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-3-去掉依赖" tabindex="-1"><a class="header-anchor" href="#_2-3-去掉依赖" aria-hidden="true">#</a> 2.3 去掉依赖</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-4-打包到镜像" tabindex="-1"><a class="header-anchor" href="#_2-4-打包到镜像" aria-hidden="true">#</a> 2.4 打包到镜像</h2>
