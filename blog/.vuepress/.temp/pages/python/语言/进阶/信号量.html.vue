...
<!-- more -->
<h1 id="信号量signal" tabindex="-1"><a class="header-anchor" href="#信号量signal"><span>信号量signal</span></a></h1>
...
<h2 id="_1-接收信号" tabindex="-1"><a class="header-anchor" href="#_1-接收信号"><span>1. 接收信号</span></a></h2>
<p><strong>Python</strong> 中使用 <strong>signal</strong> 模块来处理信号相关的操作，定义如下：</p>
<div class="language-python line-numbers-mode" data-highlighter="shiki" data-ext="python" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">signal.</span><span style="--shiki-light:#383A42;--shiki-dark:#61AFEF">signal</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">(signalnum, handler)</span></span></code></pre>
...
<div class="language-python line-numbers-mode" data-highlighter="shiki" data-ext="python" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic">#coding:utf-8</span></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">        time.</span><span style="--shiki-light:#383A42;--shiki-dark:#61AFEF">sleep</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">(</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66">3</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">)</span></span></code></pre>
...
<div class="language-python line-numbers-mode" data-highlighter="shiki" data-ext="python" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic"># python recv_signal.py</span></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">get signal: </span><span style="--shiki-light:#986801;--shiki-dark:#D19A66">1</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#56B6C2">^</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">Cget signal: </span><span style="--shiki-light:#986801;--shiki-dark:#D19A66">2</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">, I will </span><span style="--shiki-light:#0184BC;--shiki-dark:#56B6C2">quit</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>再来看另一个函数，可以对信号理解的更加透彻：</p>
<div class="language-python line-numbers-mode" data-highlighter="shiki" data-ext="python" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">signal.</span><span style="--shiki-light:#383A42;--shiki-dark:#61AFEF">getsignal</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">(signalnum)</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>根据 signalnum 返回信号对应的 handler，可能是一个可以调用的 Python 对象，或者是 <code v-pre>signal.SIG_IGN</code>（表示被忽略）, <code v-pre>signal.SIG_DFL</code>（默认行为已经被使用）或 <code v-pre>None</code>（Python 的 handler 还没被定义）。</p>
<p>看下面这个例子，获取 signal 中定义的信号 num 和名称，还有它的 handler 是什么。</p>
<div class="language-python3 line-numbers-mode" data-highlighter="shiki" data-ext="python3" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code><span class="line"><span>#coding:utf-8</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>            print name, signum, gsig</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行的结果：可以看到大部分信号都是都有默认的行为。</p>
<div class="language-python3 line-numbers-mode" data-highlighter="shiki" data-ext="python3" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code><span class="line"><span>SIG_IGN 1</span></span>
...
<span class="line"><span>SIGXFSZ 25 1</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>常用的几个信号：</p>
...
<h2 id="发送信号" tabindex="-1"><a class="header-anchor" href="#发送信号"><span>发送信号</span></a></h2>
<p>signal 包的核心是设置信号处理函数。除了 <code v-pre>signal.alarm()</code> 向自身发送信号之外，并没有其他发送信号的功能。但在 os 包中，有类似于 Linux 的 kill 命令的函数，分别为：</p>
<div class="language-python3 line-numbers-mode" data-highlighter="shiki" data-ext="python3" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code><span class="line"><span>os.kill(pid, sid)</span></span>
<span class="line"><span>os.killpg(pgid, sid)</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><p>分别向进程和进程组发送信号。sid 为信号所对应的整数或者 singal.SIG*。</p>
<h2 id="定时发出-sigalrm-信号" tabindex="-1"><a class="header-anchor" href="#定时发出-sigalrm-信号"><span>定时发出 SIGALRM 信号</span></a></h2>
<p>它被用于在一定时间之后，向进程自身发送 SIGALRM 信号，这对于避免无限期地阻塞 I/O 操作或其他系统调用很有用。</p>
<div class="language-python3 line-numbers-mode" data-highlighter="shiki" data-ext="python3" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code><span class="line"><span>import signal</span></span>
...
<span class="line"><span># After : Sat Apr 22 14:49:01 2017</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在此示例中，调用 <code v-pre>sleep()</code> 被中断，但在信号处理后继续，因此<code v-pre>sleep()</code>返回后打印的消息显示程序执行时间与睡眠持续时间一样长。</p>
<h2 id="忽略信号" tabindex="-1"><a class="header-anchor" href="#忽略信号"><span>忽略信号</span></a></h2>
...
<span class="line"><span># ^C^C^C^CExiting</span></span></code></pre>
...
<h2 id="信号与线程" tabindex="-1"><a class="header-anchor" href="#信号与线程"><span>信号与线程</span></a></h2>
...
<span class="line"><span># [1]    23188 alarm      python thread_signal.py</span></span></code></pre>
...
<span class="line"><span># Sat Apr 22 14:49:04 2017 Exiting normally</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>alarm 并没有中断 <code v-pre>use_alarm()</code> 中的 <code v-pre>sleep</code>。</p>
<p>相关文档：</p>
<p><a href="https://link.zhihu.com/?target=https%3A//pymotw.com/3/signal/index.html" target="_blank" rel="noopener noreferrer">https://pymotw.com/3/signal/index.html</a></p>
<p><a href="https://link.zhihu.com/?target=http%3A//orangleliu.info/2016/03/06/python-signal-module-simple-use/" target="_blank" rel="noopener noreferrer">http://orangleliu.info/2016/03/06/python-signal-module-simple-use/</a></p>
<p><a href="https://link.zhihu.com/?target=http%3A//www.cnblogs.com/vamei/archive/2012/10/06/2712683.html" target="_blank" rel="noopener noreferrer">http://www.cnblogs.com/vamei/archi</a></p>
</div></template>
