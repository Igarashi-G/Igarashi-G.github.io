...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="惰性计算" tabindex="-1"><a class="header-anchor" href="#惰性计算" aria-hidden="true">#</a> 惰性计算</h4>
...
<h3 id="yield-from" tabindex="-1"><a class="header-anchor" href="#yield-from" aria-hidden="true">#</a> yield from</h3>
<h4 id="yield-from-和-yield-的区别" tabindex="-1"><a class="header-anchor" href="#yield-from-和-yield-的区别" aria-hidden="true">#</a> yield from 和 yield 的区别：</h4>
<ul>
<li>
<p>简化了 yield 的操作:</p>
