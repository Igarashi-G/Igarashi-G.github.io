...
<p><a href="http://www.ruanyifeng.com/blog/2019/09/curl-reference.html" target="_blank" rel="noopener noreferrer">http://www.ruanyifeng.com/blog/2019/09/curl-reference.html<ExternalLinkIcon/></a></p>
<h2 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h2>
<p>curl 是常用的命令行工具，主要是用去请求 web 服务器。</p>
<p>它的名字就是客户端（client）的 URL 工具的意思。功能非常强大，命令行参数多达几十种。如果熟练的话，完全可以取代 Postman 这一类的图形
界面工具。</p>
<h2 id="各种命令集合" tabindex="-1"><a class="header-anchor" href="#各种命令集合" aria-hidden="true">#</a> 各种命令集合</h2>
...
<p>上面命令会移除 User-Agent 标头。</p>
<pre><code>curl -H 'User-Agent: php/1.0' https://google.com
</code></pre>
<p>也可以通过-H 参数直接指定标头，更改 User-Agent。</p>
...
<p>上面命令对<a href="https://www.example.xn--com-4d2e47f" target="_blank" rel="noopener noreferrer">https://www.example.com发出<ExternalLinkIcon/></a> POST 请求。</p>
<h3 id="补充-telnet" tabindex="-1"><a class="header-anchor" href="#补充-telnet" aria-hidden="true">#</a> 补充 telnet</h3>
<pre><code>windows下 控制面板 -&gt; 程序和功能 -&gt; 打开或关闭Windows功能 -&gt; 勾选 telnet客户端/服务端 -&gt; 等一会
