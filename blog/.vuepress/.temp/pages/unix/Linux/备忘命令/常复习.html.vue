<template><div><h1 id="linux-基本命令" tabindex="-1"><a class="header-anchor" href="#linux-基本命令" aria-hidden="true">#</a> Linux 基本命令:</h1>
<h2 id="一、bash-bourne-again-shell" tabindex="-1"><a class="header-anchor" href="#一、bash-bourne-again-shell" aria-hidden="true">#</a> 一、bash：（Bourne Again Shell）</h2>
<p>bash-shell 概述:</p>
<p>bash 是 Bourne Again Shell 的简称，是从 unix 系统中的 sh 发展而来的，是用户和 Linux 内核交互的工具，用户通过 bash 操作内核完成系统的使用和
管理。是 shell 的一种。每种 shell 的功能类似，但语法稍有不同。</p>
<pre><code>/bin/sh 已经被 /bin/bash 代替（我的是被/bin/dash 代替）
/bin/bash（默认的shell）
</code></pre>
<h2 id="二、常用命令" tabindex="-1"><a class="header-anchor" href="#二、常用命令" aria-hidden="true">#</a> 二、常用命令：</h2>
<h4 id="netstat-ntlp" tabindex="-1"><a class="header-anchor" href="#netstat-ntlp" aria-hidden="true">#</a> &lt;&gt;netstat -ntlp:</h4>
...
<h4 id="ps-ef" tabindex="-1"><a class="header-anchor" href="#ps-ef" aria-hidden="true">#</a> &lt;&gt;:ps -ef:</h4>
<p>场景：查看进程，显示状态</p>
...
<h2 id="三、快捷键" tabindex="-1"><a class="header-anchor" href="#三、快捷键" aria-hidden="true">#</a> 三、快捷键：</h2>
<ul>
