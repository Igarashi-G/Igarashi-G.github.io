...
<h4 id="ps-ef-aux" tabindex="-1"><a class="header-anchor" href="#ps-ef-aux"><span>ps -ef | -aux</span></a></h4>
<p>场景：查看进程，显示状态</p>
<pre><code>ps -ef |less 命令： ps查看进程所有信息并通过less分页显示
ps -ef | grep etutorservice : 利用管道符精确查询需要的进程，之后kill第一个的总进程即可。
</code></pre>
<h4 id="chmod-改权限" tabindex="-1"><a class="header-anchor" href="#chmod-改权限"><span>chmod：改权限</span></a></h4>
...
<h4 id="chown-改组" tabindex="-1"><a class="header-anchor" href="#chown-改组"><span>chown：改组</span></a></h4>
<p>场景：更改文件的用户名和用户组</p>
...
<h4 id="more-less-cat" tabindex="-1"><a class="header-anchor" href="#more-less-cat"><span>more &amp; less &amp; cat</span></a></h4>
...
<h4 id="ssh" tabindex="-1"><a class="header-anchor" href="#ssh"><span>ssh</span></a></h4>
...
<h4 id="scp" tabindex="-1"><a class="header-anchor" href="#scp"><span>scp</span></a></h4>
...
<h4 id="alias" tabindex="-1"><a class="header-anchor" href="#alias"><span>alias</span></a></h4>
<p>场景：利用别名简化命令</p>
...
<h5 id="快捷键" tabindex="-1"><a class="header-anchor" href="#快捷键"><span>快捷键：</span></a></h5>
<ul>
