...
<h3 id="_1-2-其他" tabindex="-1"><a class="header-anchor" href="#_1-2-其他" aria-hidden="true">#</a> 1.2 其他</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="custom-container warning">
...
<h2 id="_2-iso打包" tabindex="-1"><a class="header-anchor" href="#_2-iso打包" aria-hidden="true">#</a> 2. iso打包</h2>
...
<span class="token comment"># 构建镜像 v4.1.1</span>
<span class="token function">bash</span> ./build.sh <span class="token parameter variable">-v</span> <span class="token number">4.1</span>.1

<span class="token comment"># 查看打包后的镜像</span>
<span class="token function">ls</span> /release/4.1.1
<span class="token comment"># md5sum.txt  sha256sum.txt  ufs_centos7.9_x86_64_4.1.1-202303201458.iso  ufs_centos7.9_x86_64_4.1.1-202303201458.upgrade.tar.gz</span>

<span class="token builtin class-name">cd</span> /release/4.1.1

<span class="token comment"># 需要拷贝到上文 Nginx 环境中发布</span>
<span class="token function">scp</span> ./* <span class="token number">172.16</span>.120.41:/mnt/docker-runtime/nginx/ufs-local/release/ufs/v4.1.1/

<span class="token comment"># 172.16.128.99上虚拟机测试</span>
<span class="token function">scp</span> ./ufs_centos7.9_x86_64_4.1.1-202303201458.iso <span class="token number">172.16</span>.128.99:/vmfs/volumes/628d8920-834315d0-6c3f-a4dcbef9446e/iso/
