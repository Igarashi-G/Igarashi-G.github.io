<template><div><h1 id="ntp" tabindex="-1"><a class="header-anchor" href="#ntp"><span>NTP</span></a></h1>
<h3 id="一、关于时区与网络校时的通讯协议" tabindex="-1"><a class="header-anchor" href="#一、关于时区与网络校时的通讯协议"><span>一、关于时区与网络校时的通讯协议</span></a></h3>
<h4 id="_1-时区" tabindex="-1"><a class="header-anchor" href="#_1-时区"><span>1.时区</span></a></h4>
...
<h4 id="_2-ntp-通讯协议" tabindex="-1"><a class="header-anchor" href="#_2-ntp-通讯协议"><span>2.NTP 通讯协议</span></a></h4>
<ul>
<li>软件时钟：由 Linux 操作系统根据 1970/01/01 开始计算的总秒数； 即 date 这个指令的时间</li>
