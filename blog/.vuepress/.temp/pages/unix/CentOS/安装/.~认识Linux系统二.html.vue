<template><div><p>linux 系统下一切皆文件,就是说一切都是文件这个概念
/所有文件都源于&quot;/&quot;根
从根开始以下均为树形目录
...
<p>二、Linux 系统目录结构：
<a href="http://www.runoob.com/linux/linux-system-contents.html" target="_blank" rel="noopener noreferrer">http://www.runoob.com/linux/linux-system-contents.html<ExternalLinkIcon/></a></p>
<p>三、Linux 文件基本属性：
