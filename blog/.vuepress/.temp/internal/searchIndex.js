export const SEARCH_INDEX = [
  ...
  },
  {
    ...
    "headers": [
      {
        "level": 2,
        "title": "一、APScheduler 简介：",
        "slug": "一、apscheduler-简介",
        "link": "#一、apscheduler-简介",
        "children": []
      },
      {
        "level": 2,
      ...
      {
        "level": 2,
        "title": "三、APScheduler 的四种组成部分：",
        "slug": "三、apscheduler-的四种组成部分",
        "link": "#三、apscheduler-的四种组成部分",
        "children": [
          {
            "level": 3,
            "title": "1.触发器(trigger)：",
          ...
          {
            "level": 3,
            "title": "2.作业存储(job store)：",
            "slug": "_2-作业存储-job-store",
            "link": "#_2-作业存储-job-store",
            "children": []
          },
          {
            "level": 3,
            "title": "3.执行器(executor)：",
            "slug": "_3-执行器-executor",
            "link": "#_3-执行器-executor",
            "children": []
          },
          {
            "level": 3,
            "title": "4.调度器(scheduler)：",
            "slug": "_4-调度器-scheduler",
            "link": "#_4-调度器-scheduler",
            "children": []
          }
        ]
      },
    ...
    "headers": [
      ...
      },
      {
        ...
        "children": [
          ...
          {
            "level": 3,
            "title": "2. 通过引入单独配置文件，创建任务",
            "slug": "_2-通过引入单独配置文件-创建任务",
            "link": "#_2-通过引入单独配置文件-创建任务",
            "children": []
          }
        ]
      },
      ...
      {
        "level": 2,
        "title": "四、创建 celery 生产者",
        "slug": "四、创建-celery-生产者",
        "link": "#四、创建-celery-生产者",
        "children": []
      },
      {
        "level": 2,
        ...
        "children": [
          {
            "level": 3,
            "title": "1.通过 AsyncResult 进行简单判断：",
            "slug": "_1-通过-asyncresult-进行简单判断",
            "link": "#_1-通过-asyncresult-进行简单判断",
            "children": []
          }
        ]
      }
  ...
  },
  {
    ...
    "headers": [
      {
        "level": 2,
        "title": "手动实现异步任务（仿 Celery 模型）",
        "slug": "手动实现异步任务-仿-celery-模型",
        "link": "#手动实现异步任务-仿-celery-模型",
        "children": []
      }
    ],
    ...
    "headers": [
      ...
      },
      {
        ...
        "children": [
          {
            "level": 3,
            "title": "2.1 yield 生成器实现",
            "slug": "_2-1-yield-生成器实现",
            "link": "#_2-1-yield-生成器实现",
            "children": []
          },
          {
            "level": 3,
            "title": "2.2 greenlet 实现协程",
            "slug": "_2-2-greenlet-实现协程",
            "link": "#_2-2-greenlet-实现协程",
            "children": []
          },
          {
            "level": 3,
            "title": "2.3 yield from 和装饰器实现",
            "slug": "_2-3-yield-from-和装饰器实现",
            "link": "#_2-3-yield-from-和装饰器实现",
            "children": []
          },
          {
            "level": 3,
            "title": "2.4 async/await 实现",
            "slug": "_2-4-async-await-实现",
            "link": "#_2-4-async-await-实现",
            "children": []
          },
          {
            "level": 3,
  ...
  },
  {
    ...
    "headers": [
      {
        "level": 2,
        "title": "一.信号量(Semaphore)：",
        "slug": "一-信号量-semaphore",
        "link": "#一-信号量-semaphore",
        "children": []
      },
      {
        "level": 2,
        "title": "线程变量利器----ThreadLocal：",
        "slug": "线程变量利器-threadlocal",
        "link": "#线程变量利器-threadlocal",
        "children": []
      }
    ],
    ...
    "headers": [
      {
        ...
        "children": [
          ...
          {
            "level": 3,
            "title": "2.python 数据对象的核心基石",
            "slug": "_2-python-数据对象的核心基石",
            "link": "#_2-python-数据对象的核心基石",
            "children": []
          },
          {
            "level": 3,
      ...
      },
      {
        ...
        "children": [
          {
            "level": 3,
            "title": "1、为什么 python 语言明明没有变量声明，却是强类型语言？python 是如何检查类型的？",
            "slug": "_1、为什么-python-语言明明没有变量声明-却是强类型语言-python-是如何检查类型的",
            "link": "#_1、为什么-python-语言明明没有变量声明-却是强类型语言-python-是如何检查类型的",
            "children": []
          },
          {
            "level": 3,
            "title": "2、为什么 list，dict 等容器可以随意嵌套，如此灵活？",
            "slug": "_2、为什么-list-dict-等容器可以随意嵌套-如此灵活",
            "link": "#_2、为什么-list-dict-等容器可以随意嵌套-如此灵活",
            "children": []
          },
          {
            "level": 3,
            "title": "3、类的方法第一个参数是它自身，如何实现？",
            "slug": "_3、类的方法第一个参数是它自身-如何实现",
            "link": "#_3、类的方法第一个参数是它自身-如何实现",
            "children": []
          },
          {
            "level": 3,
            "title": "关于 python 的一致性。",
            "slug": "关于-python-的一致性。",
            "link": "#关于-python-的一致性。",
            "children": []
          },
          {
            "level": 3,
            "title": "然而就其本质而言，这些所谓的特殊方法实际上并没有什么真正特殊的地方。",
            "slug": "然而就其本质而言-这些所谓的特殊方法实际上并没有什么真正特殊的地方。",
            "link": "#然而就其本质而言-这些所谓的特殊方法实际上并没有什么真正特殊的地方。",
            "children": []
          }
        ]
      }
    ...
    "headers": [
      {
        ...
        "children": [
          ...
          {
            "level": 3,
            "title": "4.基于 new 方法实现（推荐使用，方便）",
            "slug": "_4-基于-new-方法实现-推荐使用-方便",
            "link": "#_4-基于-new-方法实现-推荐使用-方便",
            "children": []
          }
        ]
      }
  ...
  },
  {
    ...
    "headers": [
      ...
      {
        "level": 2,
        "title": "3. 函数返回值(return)",
        "slug": "_3-函数返回值-return",
        "link": "#_3-函数返回值-return",
        "children": []
      },
      {
        "level": 2,
    ...
    "headers": [
      {
        ...
        "children": [
          ...
          {
            "level": 3,
            "title": "1.2 Python 何时执行装饰器",
            "slug": "_1-2-python-何时执行装饰器",
            "link": "#_1-2-python-何时执行装饰器",
            "children": []
          },
          {
            "level": 3,
          ...
          {
            "level": 3,
            "title": "1.5 结合 nonlocal 声明",
            "slug": "_1-5-结合-nonlocal-声明",
            "link": "#_1-5-结合-nonlocal-声明",
            "children": []
          }
        ]
      },
    ...
    "headers": [
      ...
      },
      {
        ...
        "children": [
          {
            "level": 3,
            "title": "1.什么是 metaclass",
            "slug": "_1-什么是-metaclass",
            "link": "#_1-什么是-metaclass",
            "children": []
          },
          {
            "level": 3,
            "title": "2.metaclass 能解决什么问题",
            "slug": "_2-metaclass-能解决什么问题",
            "link": "#_2-metaclass-能解决什么问题",
            "children": []
          },
          {
            "level": 3,
            "title": "3.Python 底层语言设计层面是如何实现 metaclass 的",
            "slug": "_3-python-底层语言设计层面是如何实现-metaclass-的",
            "link": "#_3-python-底层语言设计层面是如何实现-metaclass-的",
            "children": []
          }
        ]
      }
  ...
  },
  {
    ...
    "headers": [
      {
        ...
        "children": [
          ...
          {
            "level": 3,
            "title": "1.3 断开 NAT 连接后",
            "slug": "_1-3-断开-nat-连接后",
            "link": "#_1-3-断开-nat-连接后",
            "children": []
          },
          {
            "level": 3,
    ...
    "path": "/unix/Linux/%E7%BD%91%E7%BB%9C/NAT%E4%B8%8E%E7%A9%BF%E9%80%8F.html",
    "pathLocale": "/",
    "extraFields": []
  },
  {
  ...
  },
  {
    ...
    "path": "/unix/Linux/%E7%BD%91%E7%BB%9C/%E5%B8%B8%E7%94%A8%E7%BD%91%E7%BB%9C%E5%91%BD%E4%BB%A4%E5%8F%8A%E5%B7%A5%E5%85%B7.html",
    "pathLocale": "/",
    "extraFields": []
  },
  {
  ...
  },
  {
    ...
    "headers": [
      ...
      {
        "level": 2,
        "title": "2. Request (请求部分)",
        "slug": "_2-request-请求部分",
        "link": "#_2-request-请求部分",
        "children": [
          {
            "level": 3,
            "title": "2.1 url 和 参数获取",
            "slug": "_2-1-url-和-参数获取",
            "link": "#_2-1-url-和-参数获取",
            "children": []
          },
          {
            "level": 3,
      ...
      {
        "level": 2,
        "title": "3. Response (响应部分 )",
        "slug": "_3-response-响应部分",
        "link": "#_3-response-响应部分",
        "children": [
          {
            "level": 3,
            "title": "3.1 响应模型",
      ...
      {
        "level": 2,
        "title": "4. FastAPI 相关配置",
        "slug": "_4-fastapi-相关配置",
        "link": "#_4-fastapi-相关配置",
        "children": [
          {
            "level": 3,
            "title": "4.1 静态资源导入",
          ...
          {
            "level": 3,
            "title": "2. fastapi 启用热更新",
            "slug": "_2-fastapi-启用热更新",
            "link": "#_2-fastapi-启用热更新",
            "children": []
          }
        ]
      }
