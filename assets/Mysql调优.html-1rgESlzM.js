import{_ as s}from"./plugin-vueexport-helper-DlAUqK2U.js";import{c as n,d as a,o as t}from"./app-BCWsQhAN.js";const e="/assets/image-20250611115432780-CrLnOf-R.png",l={};function h(d,i){return t(),n("div",null,i[0]||(i[0]=[a('<h1 id="mysql-机制详解" tabindex="-1"><a class="header-anchor" href="#mysql-机制详解"><span>MYSQL 机制详解</span></a></h1><h4 id="mysql-执行查询的过程" tabindex="-1"><a class="header-anchor" href="#mysql-执行查询的过程"><span>MySQL 执行查询的过程</span></a></h4><ol><li>客户端通过 TCP 连接发送连接请求到 MySQL 连接器，连接器会对该请求进行权限验证及连接资源分配</li><li>查缓存。（当判断缓存是否命中时，MySQL 不会进行解析查询语句，而是直接使用 SQL 语句和客户端发送过来的其他原始信息。所以，任何字符上的不同，例如空格、注解等都会导致缓存的不命中。）</li><li>语法分析（SQL 语法是否写错了）。 如何把语句给到预处理器，检查数据表和数据列是否存在，解析别名看是否存在歧义。</li><li>优化。是否使用索引，生成执行计划。</li><li>交给执行器，将数据保存到结果集中，同时会逐步将数据缓存到查询缓存中，最终将结果集返回给客户端。</li></ol><p><img src="'+e+`" alt="image-20250611115432780"></p><p>引擎：</p><ul><li><strong>InnoDB：</strong> 插入时按主键排序插入（最常用） -- 聚集</li><li><strong>MYISAM：</strong> 按照插入时顺序插入 -- 堆表（数据堆在一起）</li></ul><h2 id="一、innodb-存储结构" tabindex="-1"><a class="header-anchor" href="#一、innodb-存储结构"><span>一、InnoDB 存储结构</span></a></h2><h3 id="_1-页存储机制" tabindex="-1"><a class="header-anchor" href="#_1-页存储机制"><span>1. 页存储机制</span></a></h3><ul><li><strong>操作系统内存页</strong>：4KB</li><li><strong>InnoDB页大小</strong>：默认16KB (<code>innodb_page_size = 16384</code>)</li></ul><h4 id="页结构组成" tabindex="-1"><a class="header-anchor" href="#页结构组成"><span>页结构组成：</span></a></h4><div class="language-markdown line-numbers-mode" data-highlighter="shiki" data-ext="markdown" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">File Header</span></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">File Trailer</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-innodb行格式" tabindex="-1"><a class="header-anchor" href="#_2-innodb行格式"><span>2. InnoDB行格式</span></a></h3><table><thead><tr><th style="text-align:center;">行格式</th><th style="text-align:center;">特点</th><th style="text-align:center;">适用场景</th></tr></thead><tbody><tr><td style="text-align:center;">Compact</td><td style="text-align:center;">变长字段长度列表 + NULL标志位 + 记录头信息 + 列数据</td><td style="text-align:center;">常规使用</td></tr><tr><td style="text-align:center;">Redundant</td><td style="text-align:center;">兼容老版本</td><td style="text-align:center;">历史遗留系统</td></tr><tr><td style="text-align:center;">Dynamic</td><td style="text-align:center;">行溢出数据全部存储到其他页面，只保留地址</td><td style="text-align:center;">大字段数据</td></tr><tr><td style="text-align:center;">Compressed</td><td style="text-align:center;">在Dynamic基础上增加页面压缩</td><td style="text-align:center;">存储敏感场景</td></tr></tbody></table><p><strong>设置语法</strong>：</p><div class="language-sql line-numbers-mode" data-highlighter="shiki" data-ext="sql" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">CREATE</span><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;"> TABLE</span><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;"> 表名</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;"> (列信息) ROW_FORMAT</span><span style="--shiki-light:#383A42;--shiki-dark:#56B6C2;">=</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">行格式名称;</span></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">ALTER</span><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;"> TABLE</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;"> 表名 ROW_FORMAT</span><span style="--shiki-light:#383A42;--shiki-dark:#56B6C2;">=</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">行格式名称;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-行存储特性" tabindex="-1"><a class="header-anchor" href="#_3-行存储特性"><span>3. 行存储特性</span></a></h3><ul><li><strong>行大小限制</strong>：非BLOB字段最大65535字节</li><li><strong>隐藏列</strong>： <ul><li><code>DB_ROW_ID</code>(6B)：无主键时自动生成</li><li><code>DB_TRX_ID</code>(7B)：事务ID</li><li><code>DB_ROLL_PTR</code>(7B)：回滚指针</li></ul></li><li><strong>行溢出处理</strong>： <ul><li>方式1：当前页存部分数据+下一页地址</li><li>方式2：只存起始页和末尾页地址（与索引相关）</li></ul></li></ul><h2 id="二、索引机制" tabindex="-1"><a class="header-anchor" href="#二、索引机制"><span>二、索引机制</span></a></h2><h3 id="_1-b-树索引结构" tabindex="-1"><a class="header-anchor" href="#_1-b-树索引结构"><span>1. B+树索引结构</span></a></h3><div class="language-markdown line-numbers-mode" data-highlighter="shiki" data-ext="markdown" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">根节点(非叶子节点)</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">  ↓</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">中间节点(非叶子节点，存储主键+指针)</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">  ↓</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">叶子节点(存储实际数据)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>特点</strong>：</p><ul><li>非叶子节点仅存储键值和指针</li><li>叶子节点形成有序链表，支持高效范围查询</li><li>每个节点可存储多个元素（相比二叉树高度更低）</li></ul><h3 id="_2-索引存储计算" tabindex="-1"><a class="header-anchor" href="#_2-索引存储计算"><span>2. 索引存储计算</span></a></h3><ul><li>假设主键为BIGINT(8B)，指针6B</li><li>单页可存储键值对：16KB/(8+6) ≈ 1170</li><li>高度为3的B+树可存储：1170×1170×16 ≈ 2千万条记录</li></ul><h3 id="_3-索引使用原则" tabindex="-1"><a class="header-anchor" href="#_3-索引使用原则"><span>3. 索引使用原则</span></a></h3><h4 id="辅助索引-二级索引" tabindex="-1"><a class="header-anchor" href="#辅助索引-二级索引"><span>辅助索引（二级索引）</span></a></h4><ul><li>额外构建B+树，叶子节点存储主键值</li><li>查询流程：辅助索引→主键索引→数据（回表）</li></ul><h4 id="最左前缀原则" tabindex="-1"><a class="header-anchor" href="#最左前缀原则"><span>最左前缀原则</span></a></h4><ul><li><p>联合索引(b,c,d)只能匹配：</p><ul><li><code>WHERE b=1 AND c=1 AND d=1</code>（完全匹配）</li><li><code>WHERE b=1 AND c=1</code>（部分匹配）</li><li><code>WHERE b LIKE &#39;101%&#39;</code>（前缀匹配）</li></ul><p>不匹配：</p><ul><li><code>WHERE c=1 AND d=1</code></li><li><code>WHERE b LIKE &#39;%101%&#39;</code></li></ul></li></ul><h4 id="索引优化技巧" tabindex="-1"><a class="header-anchor" href="#索引优化技巧"><span>索引优化技巧</span></a></h4><ul><li>后缀匹配优化：<code>LIKE &#39;%com&#39;</code> → 存储逆序<code>moc%</code></li><li>NULL值在索引中视为最小值</li><li>相同值的非唯一索引会附加主键值</li></ul><h3 id="" tabindex="-1"><a class="header-anchor" href="#"><span></span></a></h3><p><strong>页目录：</strong> 本质是树，即用一个页 利用二分法进行来记录各数据的地址，每一页会有主键，并把主键提出来作为索引部分</p><div class="language-text line-numbers-mode" data-highlighter="shiki" data-ext="text" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>              页号100                       页号200</span></span>
<span class="line"><span>            1 -&gt;  1111a                   5 -&gt; 5555e</span></span>
<span class="line"><span>                  2222b       -&gt;               6666f</span></span>
<span class="line"><span>            3 -&gt;  3333c...                7 -&gt; 7777g ...</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>目录页:</strong><br> 额外提出一个页，用来存储页号，但每一页的页号可不是相邻的，反而会再用一个 key-value 去存储页号</p><pre><code>                1                          5            --  主键
               100                        200           --  指针
                |                          |
             页号100                    页号200          --  指针指向的行数据
</code></pre><ul><li>**key：**每页中最小的值， 利用主键都是递增顺序排列</li><li>**value：**对应的页号</li></ul><p>因此就是一个B+树结构(根节点的元素总会留一个在叶子节点上) 一个节点也可以存多个元素</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>                                 0003 0005</span></span>
<span class="line"><span>             |                       |                         |</span></span>
<span class="line"><span>           0002                    0004                       0005</span></span>
<span class="line"><span>        |         |           |            |              |            |</span></span>
<span class="line"><span>    0001   -&gt;    0002   -&gt;   0003    -&gt;   0004   -&gt;    0005    -&gt;    0006 0007</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>叶子节点：存数据</span></span>
...
<span class="line"><span>                   因此用B+树找最多找两次就能在2千多万条数据中找到那个页</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="基本结构" tabindex="-1"><a class="header-anchor" href="#基本结构"><span>基本结构</span></a></h4><ul><li><strong>本质</strong>：一种优化页内数据查找的二分搜索结构</li><li><strong>位置</strong>：位于每个数据页的尾部（Page Directory区域）</li><li><strong>组成：</strong><ul><li>槽位（Slots）：存储每组记录的最大主键值</li><li>指针：指向对应记录组的起始位置</li></ul></li></ul><h4 id="工作流程" tabindex="-1"><a class="header-anchor" href="#工作流程"><span>工作流程</span></a></h4><div class="language-markdown line-numbers-mode" data-highlighter="shiki" data-ext="markdown" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">数据页内部结构：</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">+---------------------+</span></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">+---------------------+</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="查找过程-以查找id-4为例" tabindex="-1"><a class="header-anchor" href="#查找过程-以查找id-4为例"><span>查找过程（以查找ID=4为例）：</span></a></h4><ol><li>通过二分查找确定ID=4位于Slot1(ID=5)和Slot2(ID=3)之间</li><li>根据指针定位到记录组（记录2到记录3之间）</li><li>在组内线性查找目标记录</li></ol><h3 id="_2-b-树索引的完整结构" tabindex="-1"><a class="header-anchor" href="#_2-b-树索引的完整结构"><span>2. B+树索引的完整结构</span></a></h3><h4 id="层级关系示例" tabindex="-1"><a class="header-anchor" href="#层级关系示例"><span>层级关系示例</span></a></h4><div class="language-markdown line-numbers-mode" data-highlighter="shiki" data-ext="markdown" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">根节点（页号300）</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">+---------------+</span></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">+---------------+       +---------------+       +---------------+</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="关键特性" tabindex="-1"><a class="header-anchor" href="#关键特性"><span>关键特性</span></a></h4><ol><li><p><strong>双向链表连接</strong>：所有叶子节点通过指针形成双向链表，支持高效范围查询</p><div class="language-markdown line-numbers-mode" data-highlighter="shiki" data-ext="markdown" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">页100 → 页150 → 页300 → ...</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div></li><li><p><strong>填充因子</strong>：每个节点通常填充15/16的空间（约93.75%）</p></li><li><p><strong>分裂规则</strong>：</p><ul><li>当页满时发生分裂</li><li>中间键值会上提到父节点</li><li>示例：页150满时分裂为页150和页155，键值7上提到父节点</li></ul></li></ol><h3 id="_3-索引操作示例" tabindex="-1"><a class="header-anchor" href="#_3-索引操作示例"><span>3. 索引操作示例</span></a></h3><h4 id="查找id-6的记录" tabindex="-1"><a class="header-anchor" href="#查找id-6的记录"><span>查找ID=6的记录</span></a></h4><ol><li>从根节点（页300）开始： <ul><li>6 &lt; 10 → 选择左分支（页200）</li></ul></li><li>在页200中： <ul><li>3 &lt; 6 ≤ 5 → 选择页150</li></ul></li><li>在页150中线性查找找到ID=6的记录F</li></ol><h4 id="范围查询id-between-4-and-8" tabindex="-1"><a class="header-anchor" href="#范围查询id-between-4-and-8"><span>范围查询ID BETWEEN 4 AND 8</span></a></h4><ol><li>定位到ID=4的起始位置（页150）</li><li>沿叶子节点链表扫描： <ul><li>页150：5(E), 6(F), 7(G)</li><li>页300：...（直到ID&gt;8停止）</li></ul></li></ol><h3 id="_4-与哈希索引的区别" tabindex="-1"><a class="header-anchor" href="#_4-与哈希索引的区别"><span>4. 与哈希索引的区别</span></a></h3><table><thead><tr><th style="text-align:center;">特性</th><th style="text-align:center;">B+树索引</th><th style="text-align:center;">哈希索引</th></tr></thead><tbody><tr><td style="text-align:center;">查询类型支持</td><td style="text-align:center;">等值、范围、排序</td><td style="text-align:center;">仅等值查询</td></tr><tr><td style="text-align:center;">磁盘I/O效率</td><td style="text-align:center;">高（顺序访问）</td><td style="text-align:center;">随机访问</td></tr><tr><td style="text-align:center;">内存利用率</td><td style="text-align:center;">高（节点可缓存）</td><td style="text-align:center;">依赖哈希表大小</td></tr><tr><td style="text-align:center;">适合场景</td><td style="text-align:center;">OLTP/OLAP</td><td style="text-align:center;">内存表/缓存</td></tr></tbody></table><h3 id="_5-实际优化案例" tabindex="-1"><a class="header-anchor" href="#_5-实际优化案例"><span>5. 实际优化案例</span></a></h3><p><strong>问题</strong>：某电商平台商品表查询缓慢</p><p><strong>解决方案</strong>：</p><div class="language-sql line-numbers-mode" data-highlighter="shiki" data-ext="sql" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;">-- 原结构</span></span>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">LIMIT</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;"> 20</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">;  </span><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;">-- 现在可以利用联合索引直接定位</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>效果</strong>：</p><ul><li>查询时间从1200ms降至15ms</li><li>磁盘I/O减少80%</li><li>内存缓存命中率提升至95%</li></ul><h2 id="三、事务机制" tabindex="-1"><a class="header-anchor" href="#三、事务机制"><span>三、事务机制</span></a></h2><h3 id="_1-acid特性" tabindex="-1"><a class="header-anchor" href="#_1-acid特性"><span>1. ACID特性</span></a></h3><table><thead><tr><th style="text-align:center;">特性</th><th style="text-align:center;">保证机制</th><th style="text-align:center;">实现原理</th></tr></thead><tbody><tr><td style="text-align:center;">原子性</td><td style="text-align:center;">Undo Log</td><td style="text-align:center;">回滚未提交事务</td></tr><tr><td style="text-align:center;">隔离性</td><td style="text-align:center;">锁/MVCC</td><td style="text-align:center;">控制并发访问</td></tr><tr><td style="text-align:center;">持久性</td><td style="text-align:center;">Redo Log</td><td style="text-align:center;">故障恢复</td></tr><tr><td style="text-align:center;">一致性</td><td style="text-align:center;">以上三者共同保证</td><td style="text-align:center;">业务规则约束</td></tr></tbody></table><h3 id="_2-事务控制语句" tabindex="-1"><a class="header-anchor" href="#_2-事务控制语句"><span>2. 事务控制语句</span></a></h3><div class="language-sql line-numbers-mode" data-highlighter="shiki" data-ext="sql" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">BEGIN</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">/</span><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">START TRANSACTION</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">;  </span><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;">-- 开启事务</span></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">RELEASE SAVEPOINT 名称;   </span><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;">-- 释放保存点</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-隔离级别对比" tabindex="-1"><a class="header-anchor" href="#_3-隔离级别对比"><span>3. 隔离级别对比</span></a></h3><table><thead><tr><th style="text-align:center;">隔离级别</th><th style="text-align:center;">脏读</th><th style="text-align:center;">不可重复读</th><th style="text-align:center;">幻读</th><th style="text-align:center;">实现机制</th></tr></thead><tbody><tr><td style="text-align:center;">READ UNCOMMITTED</td><td style="text-align:center;">可能</td><td style="text-align:center;">可能</td><td style="text-align:center;">可能</td><td style="text-align:center;">无防护</td></tr><tr><td style="text-align:center;">READ COMMITTED</td><td style="text-align:center;">不可能</td><td style="text-align:center;">可能</td><td style="text-align:center;">可能</td><td style="text-align:center;">MVCC快照读</td></tr><tr><td style="text-align:center;">REPEATABLE READ</td><td style="text-align:center;">不可能</td><td style="text-align:center;">不可能</td><td style="text-align:center;">可能*</td><td style="text-align:center;">MVCC+间隙锁</td></tr><tr><td style="text-align:center;">SERIALIZABLE</td><td style="text-align:center;">不可能</td><td style="text-align:center;">不可能</td><td style="text-align:center;">不可能</td><td style="text-align:center;">完全串行化</td></tr></tbody></table><h4 id="记忆技巧" tabindex="-1"><a class="header-anchor" href="#记忆技巧"><span><strong>记忆技巧</strong></span></a></h4><p>可以这样记忆：</p><ul><li>隔离级别名称描述的是它<strong>保证什么</strong>，而不是它<strong>禁止什么</strong></li><li>保证的内容越多，隔离级别越高</li></ul><table><thead><tr><th style="text-align:center;">隔离级别</th><th style="text-align:center;">保证内容</th></tr></thead><tbody><tr><td style="text-align:center;">READ COMMITTED</td><td style="text-align:center;">只读已提交的数据</td></tr><tr><td style="text-align:center;">REPEATABLE READ</td><td style="text-align:center;">读已提交的数据 + 同一事务内多次读取结果一致</td></tr></tbody></table><div class="hint-container tip"><p class="hint-container-title">关于 <strong>REPEATABLE READ</strong> 和幻读</p><p><strong>MySQL</strong> 的 <strong>InnoDB</strong> 在 <strong>REPEATABLE READ</strong> 隔离级别下，通过 <strong>间隙锁</strong> 解决了部分幻读，但没有完全解决快照读下的幻读问题</p><p>可以做这个实验：</p><ol><li>当前DB已有id 5, 10, 15三条数据。</li><li>事务A查询id &lt; 10的数据，可以查出一行记录id = 5</li><li>事务B插入id = 6的数据</li><li>事务A再查询id &lt; 10的数据，可以查出一行记录id = 5，查不出id = 6的数据（读场景，解决了幻读）</li><li>事务A可以更新/删除id = 6的数据，不能插入id = 6的数据（写场景，幻读不彻底）</li></ol><h4 id="实验场景复现" tabindex="-1"><a class="header-anchor" href="#实验场景复现"><span>实验场景复现</span></a></h4><div class="language-sql line-numbers-mode" data-highlighter="shiki" data-ext="sql" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;">-- 初始数据</span></span>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">DELETE</span><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;"> FROM</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;"> test </span><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">WHERE</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;"> id</span><span style="--shiki-light:#383A42;--shiki-dark:#56B6C2;">=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">6</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">;       </span><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;">-- 能删除&quot;幻影行&quot;！</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个很好理解，**MySQL **虽然通过 <strong>MVCC</strong> 的版本号来解决了读场景下的幻读，但对于上面 <strong>第5步</strong> 那种写场景的情况，其实是无能为力的，因为 <strong>MVCC</strong> 毕竟是无锁实现。</p><h5 id="mysql防幻读机制的两面性" tabindex="-1"><a class="header-anchor" href="#mysql防幻读机制的两面性"><span>MySQL防幻读机制的两面性</span></a></h5><table><thead><tr><th style="text-align:center;">防护类型</th><th style="text-align:center;">机制</th><th style="text-align:center;">效果</th><th style="text-align:center;">局限性</th></tr></thead><tbody><tr><td style="text-align:center;"><strong>读防护</strong></td><td style="text-align:center;">MVCC快照</td><td style="text-align:center;">同一事务内相同查询返回一致结果</td><td style="text-align:center;">仅适用于SELECT查询</td></tr><tr><td style="text-align:center;"><strong>写防护</strong></td><td style="text-align:center;">间隙锁</td><td style="text-align:center;">阻止其他事务插入间隙数据</td><td style="text-align:center;">只在使用锁操作时生效</td></tr></tbody></table><h5 id="为什么会出现这种-半解决-状态" tabindex="-1"><a class="header-anchor" href="#为什么会出现这种-半解决-状态"><span>为什么会出现这种&quot;半解决&quot;状态？</span></a></h5><div class="language-python line-numbers-mode" data-highlighter="shiki" data-ext="python" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;"># 技术根源： MVCC简化实现原理</span></span>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">    raise</span><span style="--shiki-light:#0184BC;--shiki-dark:#ABB2BF;"> Exception</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">(</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">&quot;并发修改冲突&quot;</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p><strong>方案3：</strong> 合理设计事务</p><div class="language-sql line-numbers-mode" data-highlighter="shiki" data-ext="sql" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;">/* 好的实践 */</span></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">BEGIN</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">;</span></span>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">COMMIT</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ul><h3 id="为什么敢用read-committed" tabindex="-1"><a class="header-anchor" href="#为什么敢用read-committed"><span>为什么敢用READ COMMITTED？</span></a></h3><ol><li><p><strong>有补偿措施</strong>：</p><p>监控系统实时检测异常数据</p><div class="language-python line-numbers-mode" data-highlighter="shiki" data-ext="python" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;"># 伪代码：定期校验数据一致性</span></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#61AFEF;">            alert</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">(</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">&quot;发现不可重复读现象&quot;</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>关键操作使用显式锁</li><li>通过业务逻辑设计规避问题</li></ul></li><li><p><strong>理解本质：</strong></p><p><strong>MySQL</strong> 的 <strong>RR</strong> 是&quot;80分解决方案&quot;，<strong>不是100% 防幻读</strong></p><div class="language-python line-numbers-mode" data-highlighter="shiki" data-ext="python" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;"># 好的代码注释示例</span></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">        )</span></span>
<span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;">        # ...业务逻辑</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ol><p>这种设计其实是工程上的权衡——在保证大部分场景可用的前提下，把复杂情况交给开发者显式处理，既获得了性能提升，又把控制权交给了最了解业务的人。</p><h3 id="_4-mvcc机制" tabindex="-1"><a class="header-anchor" href="#_4-mvcc机制"><span>4. MVCC机制</span></a></h3><ul><li><strong>版本链</strong>：通过<code>DB_TRX_ID</code>和<code>DB_ROLL_PTR</code>构建</li><li>ReadView：包含： <ul><li><code>m_ids</code>：活跃事务列表</li><li><code>min_trx_id</code>：最小活跃事务ID</li><li><code>max_trx_id</code>：预分配最大事务ID</li><li><code>creator_trx_id</code>：创建该ReadView的事务ID</li></ul></li></ul><p><strong>不同隔离级别的ReadView生成策略</strong>：</p><ul><li>READ COMMITTED：每次SELECT生成新ReadView</li><li>REPEATABLE READ：第一次SELECT生成ReadView后复用</li></ul><h2 id="四、锁机制" tabindex="-1"><a class="header-anchor" href="#四、锁机制"><span>四、锁机制</span></a></h2><h3 id="_1-锁类型矩阵" tabindex="-1"><a class="header-anchor" href="#_1-锁类型矩阵"><span>1. 锁类型矩阵</span></a></h3><table><thead><tr><th style="text-align:center;">锁类型</th><th style="text-align:center;">X锁(排他)</th><th style="text-align:center;">S锁(共享)</th><th style="text-align:center;">IS锁(意向共享)</th><th style="text-align:center;">IX锁(意向排他)</th></tr></thead><tbody><tr><td style="text-align:center;">X锁</td><td style="text-align:center;">冲突</td><td style="text-align:center;">冲突</td><td style="text-align:center;">冲突</td><td style="text-align:center;">冲突</td></tr><tr><td style="text-align:center;">S锁</td><td style="text-align:center;">冲突</td><td style="text-align:center;">兼容</td><td style="text-align:center;">兼容</td><td style="text-align:center;">冲突</td></tr><tr><td style="text-align:center;">IS锁</td><td style="text-align:center;">冲突</td><td style="text-align:center;">兼容</td><td style="text-align:center;">兼容</td><td style="text-align:center;">兼容</td></tr><tr><td style="text-align:center;">IX锁</td><td style="text-align:center;">冲突</td><td style="text-align:center;">冲突</td><td style="text-align:center;">兼容</td><td style="text-align:center;">兼容</td></tr></tbody></table><h3 id="_2-innodb锁算法" tabindex="-1"><a class="header-anchor" href="#_2-innodb锁算法"><span>2. InnoDB锁算法</span></a></h3><table><thead><tr><th style="text-align:center;">锁算法</th><th style="text-align:center;">锁定范围</th><th style="text-align:center;">解决什么问题</th></tr></thead><tbody><tr><td style="text-align:center;">Record Lock</td><td style="text-align:center;">单个行记录</td><td style="text-align:center;">保证行更新安全</td></tr><tr><td style="text-align:center;">Gap Lock</td><td style="text-align:center;">记录之间的间隙</td><td style="text-align:center;">防止幻读</td></tr><tr><td style="text-align:center;">Next-Key Lock</td><td style="text-align:center;">记录+前间隙</td><td style="text-align:center;">防止幻读(默认)</td></tr></tbody></table><h3 id="_3-不同隔离级别的锁行为" tabindex="-1"><a class="header-anchor" href="#_3-不同隔离级别的锁行为"><span>3. 不同隔离级别的锁行为</span></a></h3><h4 id="read-committed" tabindex="-1"><a class="header-anchor" href="#read-committed"><span>READ COMMITTED：</span></a></h4><ul><li>仅使用Record Lock</li><li>可能出现幻读</li></ul><h4 id="repeatable-read" tabindex="-1"><a class="header-anchor" href="#repeatable-read"><span>REPEATABLE READ：</span></a></h4><ul><li>默认使用Next-Key Lock</li><li>基本解决幻读问题</li><li>全表扫描会锁全表</li></ul><h3 id="_4-乐观锁与悲观锁对比" tabindex="-1"><a class="header-anchor" href="#_4-乐观锁与悲观锁对比"><span>4. 乐观锁与悲观锁对比</span></a></h3><table><thead><tr><th style="text-align:center;">特性</th><th style="text-align:center;">悲观锁</th><th style="text-align:center;">乐观锁</th></tr></thead><tbody><tr><td style="text-align:center;">原理</td><td style="text-align:center;">先加锁后访问</td><td style="text-align:center;">版本号/时间戳校验</td></tr><tr><td style="text-align:center;">实现</td><td style="text-align:center;"><code>SELECT...FOR UPDATE</code></td><td style="text-align:center;">应用层实现</td></tr><tr><td style="text-align:center;">优点</td><td style="text-align:center;">保证强一致性</td><td style="text-align:center;">高并发性能</td></tr><tr><td style="text-align:center;">缺点</td><td style="text-align:center;">锁开销大</td><td style="text-align:center;">重试成本高</td></tr><tr><td style="text-align:center;">适用</td><td style="text-align:center;">写多读少</td><td style="text-align:center;">读多写少</td></tr></tbody></table><p><strong>乐观锁实现示例</strong>：</p><div class="language-python line-numbers-mode" data-highlighter="shiki" data-ext="python" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;"># 需要设置隔离级别为READ COMMITTED</span></span>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">        raise</span><span style="--shiki-light:#0184BC;--shiki-dark:#ABB2BF;"> Exception</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">(</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">&quot;更新失败&quot;</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="五、sql优化建议" tabindex="-1"><a class="header-anchor" href="#五、sql优化建议"><span>五、SQL优化建议</span></a></h2><ol><li><p><strong>字段设计</strong>：</p><ul><li>使用合适的数据类型</li><li>尽量设置NOT NULL</li><li>枚举类型使用ENUM</li></ul></li><li><p><strong>查询优化</strong>：</p><ul><li>用JOIN代替子查询</li><li>用UNION代替临时表</li><li>合理使用索引</li></ul></li><li><p><strong>事务优化</strong>：</p><ul><li>缩短事务执行时间</li><li>避免长事务</li><li>合理设置隔离级别</li></ul></li><li><p><strong>锁优化</strong>：</p><ul><li>尽量使用行锁而非表锁</li><li>访问量大的系统考虑READ COMMITTED</li><li>关键业务使用SERIALIZABLE</li></ul><p>三、索引：<br> 页目录：<br> 本质是树，即用一个页 利用二分法进行来记录各数据的地址，每一页会有主键，并把主键提出来作为索引部分</p><pre><code>           页号100                       页号200
         1 -&gt;  1111a                   5 -&gt; 5555e
               2222b       -&gt;               6666f
         3 -&gt;  3333c...                7 -&gt; 7777g ...
...
</code></pre></li></ol><p>MYSQL 事务：</p><pre><code>一、事务（ACID）
    场景：小明向小胖转账10块钱
...
七、锁
    ...
    9.优化SQL的方法：
        ...
        6.适用外键，优化锁定表
        7.建立索引
</code></pre><h2 id="快照读没有完全解决幻读" tabindex="-1"><a class="header-anchor" href="#快照读没有完全解决幻读"><span>快照读没有完全解决幻读？</span></a></h2><p>是的，MySQL没有完全解决快照读下的幻读问题。</p><p>可以做这个实验：</p><ol><li>当前DB已有id 5, 10, 15三条数据。</li><li>事务A查询id &lt; 10的数据，可以查出一行记录id = 5</li><li>事务B插入id = 6的数据</li><li>事务A再查询id &lt; 10的数据，可以查出一行记录id = 5，查不出id = 6的数据（读场景，解决了幻读）</li><li>事务A可以更新/删除id = 6的数据，不能插入id = 6的数据（写场景，幻读不彻底）</li></ol><p>这个很好理解，MySQL虽然通过MVCC的版本号来解决了读场景下的幻读，但对于上面第5步那种写场景的情况，其实是无能为力的，因为MVCC毕竟是无锁实现。</p><p>所以如果后续要对数据进行写操作，还是<strong>通过for update语句上锁</strong>比较稳妥，不然就可能会出现上面第5步那样的问题。</p></div>`,76)]))}const p=s(l,[["render",h]]),c=JSON.parse('{"path":"/database/MySQL/Mysql%E8%B0%83%E4%BC%98.html","title":"Mysql调优","lang":"zh-CN","frontmatter":{"title":"Mysql调优","order":4,"description":"MYSQL 机制详解 MySQL 执行查询的过程 客户端通过 TCP 连接发送连接请求到 MySQL 连接器，连接器会对该请求进行权限验证及连接资源分配 查缓存。（当判断缓存是否命中时，MySQL 不会进行解析查询语句，而是直接使用 SQL 语句和客户端发送过来的其他原始信息。所以，任何字符上的不同，例如空格、注解等都会导致缓存的不命中。） 语法分析（...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Mysql调优\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2025-08-11T02:51:40.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"悦·宝宝\\",\\"url\\":\\"https://github.com/Igarashi-G\\"}]}"],["meta",{"property":"og:url","content":"https://igarashi-g.github.io/database/MySQL/Mysql%E8%B0%83%E4%BC%98.html"}],["meta",{"property":"og:site_name","content":"悦 ▪ 宝宝"}],["meta",{"property":"og:title","content":"Mysql调优"}],["meta",{"property":"og:description","content":"MYSQL 机制详解 MySQL 执行查询的过程 客户端通过 TCP 连接发送连接请求到 MySQL 连接器，连接器会对该请求进行权限验证及连接资源分配 查缓存。（当判断缓存是否命中时，MySQL 不会进行解析查询语句，而是直接使用 SQL 语句和客户端发送过来的其他原始信息。所以，任何字符上的不同，例如空格、注解等都会导致缓存的不命中。） 语法分析（..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-08-11T02:51:40.000Z"}],["meta",{"property":"article:modified_time","content":"2025-08-11T02:51:40.000Z"}]]},"git":{"createdTime":1665586687000,"updatedTime":1754880700000,"contributors":[{"name":"Igarashi","username":"Igarashi","email":"2545369032@qq.com","commits":1,"url":"https://github.com/Igarashi"},{"name":"Igarashi-G","username":"Igarashi-G","email":"2545369032@qq.com","commits":2,"url":"https://github.com/Igarashi-G"}]},"readingTime":{"minutes":36.07,"words":10821},"filePathRelative":"database/MySQL/Mysql调优.md","excerpt":"\\n<h4>MySQL 执行查询的过程</h4>\\n<ol>\\n<li>客户端通过 TCP 连接发送连接请求到 MySQL 连接器，连接器会对该请求进行权限验证及连接资源分配</li>\\n<li>查缓存。（当判断缓存是否命中时，MySQL 不会进行解析查询语句，而是直接使用 SQL 语句和客户端发送过来的其他原始信息。所以，任何字符上的不同，例如空格、注解等都会导致缓存的不命中。）</li>\\n<li>语法分析（SQL 语法是否写错了）。 如何把语句给到预处理器，检查数据表和数据列是否存在，解析别名看是否存在歧义。</li>\\n<li>优化。是否使用索引，生成执行计划。</li>\\n<li>交给执行器，将数据保存到结果集中，同时会逐步将数据缓存到查询缓存中，最终将结果集返回给客户端。</li>\\n</ol>","autoDesc":true}');export{p as comp,c as data};
