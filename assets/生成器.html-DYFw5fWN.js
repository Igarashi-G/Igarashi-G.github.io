import{_ as l}from"./plugin-vueexport-helper-DlAUqK2U.js";import{c as e,a as n,d as t,b as s,e as h,w as k,r as p,o as d}from"./app-C_J498dg.js";const r="/assets/yield_from-CAMeZmnC.png",o={};function A(g,i){const a=p("RouteLink");return d(),e("div",null,[n("p",null,[i[1]||(i[1]=s("所有的生成器都是 ")),h(a,{to:"/python/%E8%AF%AD%E8%A8%80/%E8%BF%9B%E9%98%B6/%E8%BF%AD%E4%BB%A3%E5%99%A8.html"},{default:k(()=>i[0]||(i[0]=[s("迭代器")])),_:1}),i[2]||(i[2]=s("，因为生成器 ")),i[3]||(i[3]=n("strong",null,"完全实现",-1)),i[4]||(i[4]=s(" 了迭代器接口"))]),i[5]||(i[5]=t(`<h1 id="生成器" tabindex="-1"><a class="header-anchor" href="#生成器"><span>生成器</span></a></h1><p>迭代器从集合中取元素，而生成器用于 <strong>凭空</strong> 生成元素</p><div class="hint-container info"><p class="hint-container-title">总之</p><p>含有 <strong>yield</strong> 关键字的 <strong>函数</strong> 就是 <strong>生成器函数</strong></p></div><h3 id="_1-1-生成器表达式" tabindex="-1"><a class="header-anchor" href="#_1-1-生成器表达式"><span>1.1 生成器表达式</span></a></h3><p><code>genexpr = (推导式)</code> 的这种形式 <strong>是生成器的语法糖</strong>， 非元组，要区别于 <code>tuple(推导式)</code></p><div class="language-python line-numbers-mode" data-highlighter="shiki" data-ext="python" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">s </span><span style="--shiki-light:#383A42;--shiki-dark:#56B6C2;">=</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;"> (x </span><span style="--shiki-light:#383A42;--shiki-dark:#56B6C2;">*</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;"> 2</span><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;"> for</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;"> x </span><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">in</span><span style="--shiki-light:#0184BC;--shiki-dark:#56B6C2;"> range</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">(</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">10</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">))</span></span>
...
<span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;"># &lt;generator object &lt;genexpr&gt; at 0x0000013EF1BF84A0&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此时打印出了 <strong>generator</strong> 对象，它保存的与列表、集合（<em>这种存值的情况</em>）是不同的，存了程序的上下文状态，因此一样不占内存，还可以像迭代器一样，用 <code>__next__()</code> 来取值，但只能顺序取</p><div class="language-python line-numbers-mode" data-highlighter="shiki" data-ext="python" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">s.</span><span style="--shiki-light:#0184BC;--shiki-dark:#56B6C2;">__next__</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">()</span></span>
...
<span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;"># 2</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="惰性计算" tabindex="-1"><a class="header-anchor" href="#惰性计算"><span>惰性计算</span></a></h4><p>生成器表达式前的语句是惰性计算的，即只在真正执行时，才计算表达式，可以避免不必要的计算，提升性能</p><div class="language-python line-numbers-mode" data-highlighter="shiki" data-ext="python" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">l </span><span style="--shiki-light:#383A42;--shiki-dark:#56B6C2;">=</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;"> [</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">1</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">,</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">2</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">,</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">3</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">]</span></span>
...
</code></pre><p>5.1 生成器伪并发:<br> 论单核如何实现(伪物)并发:<br> 比如同时听歌和看电影 CPU 轮询切换执行(事实上就是先看一段电影在执行一段音乐)只是由于 CPU 切换实在是太快了 0.0...0 几秒<br> 因此感官上感觉是在&quot;同时&quot;执行 或是&quot;并发&quot;的。(人眼处理 == 当每秒帧数&lt;24 当秒速超过 24 时 便意识为连续)<br> 所以是(伪)有先后的<br> 真正的并发还是要有多核多个线程同时执行<br> 下面是一个官方更新的同时模拟多个用户在线看的伪并发(感觉是同时发生的其实不是)<br> import time</p><pre><code>def consumer(name):
    print(&quot;%s 准备看番啦&quot; % name)
    while True:
        animate = yield
...
</code></pre><h3 id="yield-from" tabindex="-1"><a class="header-anchor" href="#yield-from"><span>yield from</span></a></h3><h4 id="yield-from-和-yield-的区别" tabindex="-1"><a class="header-anchor" href="#yield-from-和-yield-的区别"><span>yield from 和 yield 的区别：</span></a></h4><ul><li><p>简化了 yield 的操作:</p><div class="language-python line-numbers-mode" data-highlighter="shiki" data-ext="python" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">for</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;"> i </span><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">in</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;"> titles:    等价于  </span><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">yield from</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;"> titles</span></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">    yield</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;"> title</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p>省去了很多异常的处理:</p><blockquote><p>例如<code>send(None)</code> 不会报错等</p></blockquote></li><li><p>建立调用方和子生成器的通道</p></li></ul><div class="language-python line-numbers-mode" data-highlighter="shiki" data-ext="python" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">def</span><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;"> generator_1</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">():</span></span>
...
<span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;"># g2.send(None)</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#61AFEF;">main</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">()</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><p>【子生成器】：yield from 后的 generator_1()生成器函数是子生成器</p></li><li><p>【委托生成器】：generator_2()是程序中的委托生成器，它负责委托子生成器完成具体任务。</p></li><li><p>【调用方】：main()是程序中的调用方，负责调用委托生成器。</p><ul><li>在上述代码中 main()每一次在调用 send(value)时，value 不是传递给了委托生成器 generator_2()，而是借助 yield from 传递给了子生成器 generator_1()中的 yield</li><li>同理，子生成器中的数据也是通过 yield 直接发送到调用方 main()中。</li></ul></li></ul><img src="`+r+'">',25))])}const y=l(o,[["render",A]]),u=JSON.parse('{"path":"/python/%E8%AF%AD%E8%A8%80/%E8%BF%9B%E9%98%B6/%E7%94%9F%E6%88%90%E5%99%A8.html","title":"生成器","lang":"zh-CN","frontmatter":{"title":"生成器","date":"2020-07-15T00:00:00.000Z","category":["Python"],"tag":["Python","生成器"],"star":true,"description":"所有的生成器都是 迭代器，因为生成器 完全实现 了迭代器接口","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"生成器\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2020-07-15T00:00:00.000Z\\",\\"dateModified\\":\\"2022-11-16T01:28:38.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"悦·宝宝\\",\\"url\\":\\"https://github.com/Igarashi-G\\"}]}"],["meta",{"property":"og:url","content":"https://igarashi-g.github.io/python/%E8%AF%AD%E8%A8%80/%E8%BF%9B%E9%98%B6/%E7%94%9F%E6%88%90%E5%99%A8.html"}],["meta",{"property":"og:site_name","content":"悦 ▪ 宝宝"}],["meta",{"property":"og:title","content":"生成器"}],["meta",{"property":"og:description","content":"所有的生成器都是 迭代器，因为生成器 完全实现 了迭代器接口"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2022-11-16T01:28:38.000Z"}],["meta",{"property":"article:tag","content":"生成器"}],["meta",{"property":"article:tag","content":"Python"}],["meta",{"property":"article:published_time","content":"2020-07-15T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2022-11-16T01:28:38.000Z"}]]},"git":{"createdTime":1663517244000,"updatedTime":1668562118000,"contributors":[{"name":"Igarashi","username":"Igarashi","email":"2545369032@qq.com","commits":6,"url":"https://github.com/Igarashi"}]},"readingTime":{"minutes":7.64,"words":2291},"filePathRelative":"python/语言/进阶/生成器.md","excerpt":"<p>所有的生成器都是 <a href=\\"/python/%E8%AF%AD%E8%A8%80/%E8%BF%9B%E9%98%B6/%E8%BF%AD%E4%BB%A3%E5%99%A8.html\\" target=\\"_blank\\">迭代器</a>，因为生成器 <strong>完全实现</strong> 了迭代器接口</p>\\n","autoDesc":true}');export{y as comp,u as data};
