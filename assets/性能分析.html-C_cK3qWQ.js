import{_ as t}from"./plugin-vueexport-helper-DlAUqK2U.js";import{c as n,d as r,o as i}from"./app-CRw80d8Q.js";const a={};function s(d,e){return i(),n("div",null,e[0]||(e[0]=[r(`<h1 id="redis-性能分析-一文揭秘单线程的-redis-为什么这么快" tabindex="-1"><a class="header-anchor" href="#redis-性能分析-一文揭秘单线程的-redis-为什么这么快"><span>Redis 性能分析：（一文揭秘单线程的 Redis 为什么这么快）</span></a></h1><p>一、Redis 为啥快 1.纯内存操作 2.单线程 3.高效的数据结构 4.合理的数据编码 5.其他方面的优化</p><pre><code>在 Redis 中，常用的 5 种数据结构和应用场景如下：
    - String：缓存、计数器、分布式锁等。
