import{_ as r}from"./plugin-vueexport-helper-DlAUqK2U.js";import{c as o,a as t,b as e,o as i}from"./app-C1-GdX0S.js";const a={};function s(p,n){return i(),o("div",null,n[0]||(n[0]=[t("p",null,[e("接口的调用通常分为三类： 1.同步调用："),t("br"),e(" 是一种阻塞式调用，调用方要等待对方执行完毕才返回，它是一种单向调用")],-1),t("pre",null,[t("code",null,`2.回调：
