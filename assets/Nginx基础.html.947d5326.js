...
</code></pre><h3 id="backup" tabindex="-1"><a class="header-anchor" href="#backup" aria-hidden="true">#</a> backup</h3><p>\u5907\u4EFD\uFF1A</p>`,39);function tn(rn,on){const i=t("ExternalLinkIcon"),r=t("Tabs");return p(),u("div",null,[n("p",null,[n("a",g,[s("Nginx"),e(i)]),s(" \u662F "),h,s("\uFF08"),_,s("\uFF09\uFF0C"),k,s(" \u8BED\u8A00\u5199\u7684\uFF0C\u53F7\u79F0\u652F\u6301\u767E\u4E07\u5E76\u53D1\uFF0C\u5BF9 "),x,s(" \u652F\u6301\u8F83\u5DEE")]),v(" more "),f,w,n("ul",null,[y,n("li",null,[n("a",$,[q,e(i)]),s("\uFF1A\u6DD8\u5B9D\u5728 "),N,s(" \u7684\u57FA\u7840\u4E0A\u8FDB\u884C\u4E86\u4E8C\u6B21\u5C01\u88C5\uFF0C\u5F00\u6E90\u7684\uFF0C\u9488\u5BF9\u5927\u8BBF\u95EE\u91CF\u7F51\u7AD9\u7684\u9700\u6C42\uFF08"),S,s("\uFF09")]),T]),A,e(r,{data:[{title:"CentOS"},{title:"Debain"}]},{tab0:l(({title:o,value:c,isActive:d})=>[n("h5",P,[I,s(),n("strong",null,[n("a",L,[s("\u6E90\u7801\u5305\u5B89\u88C5"),e(i)])])]),C,E,H,V,F,W,j,z,B,D,M]),tab1:l(({title:o,value:c,isActive:d})=>[G,O,U,J,R,X,K,Q,Y,Z,nn,sn,en,an]),_:1}),ln])}const mn=m(b,[["render",tn],["__file","Nginx\u57FA\u7840.html.vue"]]);export{mn as default};
