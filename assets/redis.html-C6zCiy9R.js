import{_ as s}from"./plugin-vueexport-helper-DlAUqK2U.js";import{c as n,d as e,o as a}from"./app-CTFmTszT.js";const t={};function l(r,i){return a(),n("div",null,i[0]||(i[0]=[e(`<h1 id="redis" tabindex="-1"><a class="header-anchor" href="#redis"><span>Redis</span></a></h1><h2 id="_1-redis概述" tabindex="-1"><a class="header-anchor" href="#_1-redis概述"><span>1. Redis概述</span></a></h2><h3 id="_1-1-简介" tabindex="-1"><a class="header-anchor" href="#_1-1-简介"><span>1.1 简介</span></a></h3><p>**Redis(<em>REmote DIctionary Server</em>)**是一个开源（BSD许可）的，内存中的数据结构存储系统，它可以用作数据库、缓存和消息中间件。</p><h5 id="特性" tabindex="-1"><a class="header-anchor" href="#特性"><span>特性</span></a></h5><ul><li><p>性能高</p></li><li><p>丰富的数据类型</p></li><li><p>支持事务</p></li><li><p>内建replication及集群</p></li><li><p>支持持久化</p></li><li><p>单线程，原子性操作（后续引入多线程，可配置开关）</p></li></ul><h3 id="_1-2-nosql数据库" tabindex="-1"><a class="header-anchor" href="#_1-2-nosql数据库"><span>1.2 NoSQL数据库</span></a></h3><p>NoSQL（Not Only SQL）是非关系型数据库的统称，主要用于解决Web2.0时代带来的大规模数据处理挑战。</p><h5 id="web2-0时代背景" tabindex="-1"><a class="header-anchor" href="#web2-0时代背景"><span>Web2.0时代背景</span></a></h5><ul><li><strong>UGC (User Generate Content)</strong>：用户由被动接收转为主动产生内容</li><li><strong>SNS (Social Network Society)</strong>：社交网络的兴起，如Facebook、Twitter、WeChat等</li></ul><h4 id="_1-2-1-四大分类" tabindex="-1"><a class="header-anchor" href="#_1-2-1-四大分类"><span>1.2.1 四大分类</span></a></h4><ol><li><p><strong>键值(Key-Value)存储</strong></p><ul><li>特点：使用哈希表，具有特定键和指针</li><li>优势：简单、易部署</li><li>代表产品：Redis, Tokyo Cabinet/Tyrant, Voldemort, Oracle BDB</li></ul></li><li><p><strong>列存储数据库</strong></p><ul><li>应用：分布式海量数据存储</li><li>特点：面向列的存储和检索</li><li>代表产品：Cassandra, HBase, Riak</li></ul></li><li><p><strong>文档型数据库</strong></p><ul><li>特点：类似键值存储，但支持嵌套键值对</li><li>数据格式：JSON等半结构化文档</li><li>代表产品：MongoDB, CouchDB, SequoiaDB</li></ul></li><li><p><strong>图形(Graph)数据库</strong></p><ul><li>特点：使用灵活的图形模型</li><li>应用：社交网络关系存储</li><li>代表产品：Neo4J, InfoGrid, Infinite Graph</li></ul></li></ol><h4 id="_1-2-2-适用场景" tabindex="-1"><a class="header-anchor" href="#_1-2-2-适用场景"><span>1.2.2 适用场景</span></a></h4><ul><li>数据模型简单</li><li>需要更灵活的系统架构</li><li>高性能要求</li><li>数据一致性要求不高</li><li>易于映射复杂值的环境</li></ul><h3 id="_1-3-源码编译与调试" tabindex="-1"><a class="header-anchor" href="#_1-3-源码编译与调试"><span>1.3 源码编译与调试</span></a></h3><p><strong>源码下载:</strong> <a href="https://github.com/redis/redis" target="_blank" rel="noopener noreferrer">git地址</a> 或者 <a href="https://download.redis.io/releases/" target="_blank" rel="noopener noreferrer"> Index of /releases/</a></p><p><strong>wget也可以下载:</strong></p><div class="language-shell line-numbers-mode" data-highlighter="shiki" data-ext="shell" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">wget</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> http://download.redis.io/releases/redis-</span><span style="--shiki-light:#E45649;--shiki-dark:#ABB2BF;">\${</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75;">version</span><span style="--shiki-light:#E45649;--shiki-dark:#ABB2BF;">}</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">.tar.gz</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">tar</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> xzf</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> redis-6.0.8.tar.gz</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>执行编译</p><ul><li>修改配置文件中的daemon为yes</li><li>禁用gcc编译优化，将makefile文件中OPTIMIZATION?=-O2修为-O0，可直接使用源码包下的二进制程序</li><li>gdb redis-server [conf]，配合gdb相关命令</li><li>也可以直接开启server.c的main测试函数</li></ul><h3 id="_1-4-压测" tabindex="-1"><a class="header-anchor" href="#_1-4-压测"><span>1.4 压测</span></a></h3><p><strong>Redis-benchmark</strong> 是官方自带的 <strong>Redis</strong> 性能测试工具，可以有效的测试 <strong>Redis</strong> 服务的性能。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>redis-benchmark [-h &lt;host&gt;] [-p &lt;port&gt;] [-c &lt;clients&gt;] [-n &lt;requests]&gt; [-k &lt;boolean&gt;]</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h3 id="_1-5-安装配置" tabindex="-1"><a class="header-anchor" href="#_1-5-安装配置"><span>1.5 安装配置</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;"># Ubuntu安装</span></span>
...
</code></pre>`,57)]))}const p=s(t,[["render",l]]),o=JSON.parse('{"path":"/database/Redis/redis.html","title":"Redis","lang":"zh-CN","frontmatter":{"title":"Redis","order":1,"group":{"title":"Redis","order":4},"description":"Redis 1. Redis概述 1.1 简介 **Redis(REmote DIctionary Server)**是一个开源（BSD许可）的，内存中的数据结构存储系统，它可以用作数据库、缓存和消息中间件。 特性 性能高 丰富的数据类型 支持事务 内建replication及集群 支持持久化 单线程，原子性操作（后续引入多线程，可配置开关） 1.2 ...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Redis\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2025-08-11T02:51:40.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"悦·宝宝\\",\\"url\\":\\"https://github.com/Igarashi-G\\"}]}"],["meta",{"property":"og:url","content":"https://igarashi-g.github.io/database/Redis/redis.html"}],["meta",{"property":"og:site_name","content":"悦 ▪ 宝宝"}],["meta",{"property":"og:title","content":"Redis"}],["meta",{"property":"og:description","content":"Redis 1. Redis概述 1.1 简介 **Redis(REmote DIctionary Server)**是一个开源（BSD许可）的，内存中的数据结构存储系统，它可以用作数据库、缓存和消息中间件。 特性 性能高 丰富的数据类型 支持事务 内建replication及集群 支持持久化 单线程，原子性操作（后续引入多线程，可配置开关） 1.2 ..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-08-11T02:51:40.000Z"}],["meta",{"property":"article:modified_time","content":"2025-08-11T02:51:40.000Z"}]]},"git":{"createdTime":1665586687000,"updatedTime":1754880700000,"contributors":[{"name":"Igarashi","username":"Igarashi","email":"2545369032@qq.com","commits":1,"url":"https://github.com/Igarashi"},{"name":"Igarashi-G","username":"Igarashi-G","email":"2545369032@qq.com","commits":2,"url":"https://github.com/Igarashi-G"}]},"readingTime":{"minutes":18.82,"words":5646},"filePathRelative":"database/Redis/redis.md","excerpt":"\\n<h2>1. Redis概述</h2>\\n<h3>1.1 简介</h3>\\n<p>**Redis(<em>REmote DIctionary Server</em>)**是一个开源（BSD许可）的，内存中的数据结构存储系统，它可以用作数据库、缓存和消息中间件。</p>\\n<h5>特性</h5>\\n<ul>\\n<li>\\n<p>性能高</p>\\n</li>\\n<li>\\n<p>丰富的数据类型</p>\\n</li>\\n<li>\\n<p>支持事务</p>\\n</li>\\n<li>\\n<p>内建replication及集群</p>\\n</li>\\n<li>\\n<p>支持持久化</p>\\n</li>\\n<li>\\n<p>单线程，原子性操作（后续引入多线程，可配置开关）</p>\\n</li>\\n</ul>","autoDesc":true}');export{p as comp,o as data};
